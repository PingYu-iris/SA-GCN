...
def create_2d_data_sk2im( actions, data_dir, rcams ):
  ...
  # Load 3d data
  train_set = load_data( data_dir, TRAIN_SUBJECTS+TEST_SUBJECTS, train_actions, dim=3 )
  test_set  = load_data( data_dir, TRAIN_SUBJECTS+TEST_SUBJECTS, actions, dim=3 )
...
def read_2d_predictions( actions, data_dir, rcams ):
  ...
  # predicted 2d pose
  train_set = load_stacked_hourglass( data_dir, TRAIN_SUBJECTS+TEST_SUBJECTS, actions)
  test_set  = load_stacked_hourglass( data_dir, TRAIN_SUBJECTS+TEST_SUBJECTS, actions)
